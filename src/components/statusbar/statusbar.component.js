...
class Statusbar extends Component {
   ...
   */
  imports() {
    return [this.getFontResource('maple'), this.getIconResource('material'), this.getLibraryResource('awoo')];
  }
    ...
    return `
      *:not(:defined) { display: none; }
      ...
      #tabs ul li:not(:last-child) {
          width: 35px;
          text-align: center;
          font: 700 13px 'Maple Mono', serif;
        ...
        <div id="tabs">
            <cols>
                <button class="+ fastlink">
                  <img class="fastlink-icon" src="src/img/frantz.png"/>
                </button>
